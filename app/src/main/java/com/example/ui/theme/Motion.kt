 ...
 *
 * Every member still referenced is preserved by name ([EaseStandard], [EaseAmbient], [Ambient],
 * [Reactive], [Drift], [SpringPress], [PressScale], [RestScale]); values are retuned for the
 * new calm. (Unused members — EaseEnter, EaseExit, Quick, Base, Slow, SpringSoft — were
 * removed; none had a remaining consumer.)
 */
object Motion {
